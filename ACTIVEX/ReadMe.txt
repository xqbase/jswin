========================================================================
		ActiveX Control DLL : JSWIN
========================================================================

ControlWizard has created this project for your JSWIN ActiveX Control
...
that make up your JSWIN ActiveX Control DLL.
...
JsWinCtl.h
	This file contains the declaration of the CJsWinCtrl C++ class.

JsWinCtl.cpp
	This file contains the implementation of the CJsWinCtrl C++ class.

JsWinPpg.h
	This file contains the declaration of the CJsWinPropPage C++ class.

JsWinPpg.cpp
	This file contains the implementation of the CJsWinPropPage C++ class.

JsWinCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CJsWinCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file JsWin.rc.
